...
{links.map((sm)=>(
  // <p className="max-w-fit border border-purple-500/30 bg-purple-500/5 text-center text-purple-300 transition hover:border-cyan-400/50 hover:text-cyan-300">
            <Link
              href={sm[1]}
              className="rounded border border-purple-500/40 mx-2 my-3 px-1 py-1 font-mono text-xs text-purple-300 transition hover:border-cyan-400 hover:text-cyan-300"
            >
              {sm[0]}
            </Link>
            //</p>
